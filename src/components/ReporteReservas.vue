<template>
    <div>
        ...
        <template v-slot:items="props">
            ...
            <td class="text-xs-right">{{ fechaCompleta(props.item.Year, props.item.Month, props.item.Day ) }}</td>            
...
export default {
    name: 'ReporteReservas',
        data: () => ({
            ...
            headers: [
                ...
                { text: 'Cantidad de veces solicitada', align: 'center' ,value: 'CantidadPersonas', sortable: true, },
    ...
    methods: {
        initialize () {
            this.desserts = [];
            axios.get(`${this.$api}/reportes/reservas`)
            .then(res=>{
        ...
        filtrar(){
            ...
            axios.post(`${this.$api}/reportes/reservas/fecha`,{
                fechaInicio,
                fechaFin,
            }).then(res=>{
